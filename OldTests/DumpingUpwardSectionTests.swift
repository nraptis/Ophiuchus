...
struct DumpingUpwardSectionTests {
    ...
    @MainActor @Test func test_group_section_1_row_1_section() {
        ...
        _ = SkeletonLayoutGrowthPlanTool.getRowGrowthPlansForSections(sectionList: sectionGroup.linkedList,
                                                                   sectionListCount: sectionGroup.linkedList.count,
                                                                   sectionAmountList: SkeletonLayoutGrowthPlanTool.sectionAmountList)
    ...
    @MainActor @Test func test_group_several_small_groups_512() {
        ...
        for _ in 0..<512 {
            ...
            for index in 0..<SkeletonLayoutGrowthPlanTool.rowListCount {
                guard SkeletonLayoutGrowthPlanTool.groupedSectionListCount[index] == row_list[index].children.count else {
                    #expect(Bool(false))
                    return
                }
                ...
                for section_index in 0..<SkeletonLayoutGrowthPlanTool.groupedSectionListCount[index] {
                    ...
                    let section_2 = row_list[index].children[section_index]
